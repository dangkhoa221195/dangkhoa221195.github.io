...
class Session
{
    ...
    /**
	 * start session
	 * @param $sessionName string: name of session
	 * @param $secure bool: if TRUE cookie will only be sent over secure connections.
	 */
     ...
     * @param $id string: session id
     * @param $data string: data of session
     *
     */
    ...
    /**
     * Get key from database to encrypt data
     * @param $id string: session id
     * return key or random_key
     */
     ...
     * @param $data string: data of session
     * @param $key string: key from database to encrypt data
